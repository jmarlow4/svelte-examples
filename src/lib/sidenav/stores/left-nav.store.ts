...
const initialUserVal: boolean =
	browser && !!localStorage.leftNavUserPref ? JSON.parse(localStorage.leftNavUserPref) : true;
...
import { BREAKPOINTS, breakpoints } from '$lib/stores/breakpoints';
import { leftNavTween, LEFT_NAV_WIDTH } from '../tweens/left-nav.tween';
